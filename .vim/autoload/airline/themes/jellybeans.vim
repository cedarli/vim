...
function! airline#themes#jellybeans#refresh()
  ...
  let s:N1 = airline#themes#get_highlight('DiffAdd', 'bold')
  ...
  let g:airline#themes#jellybeans#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N2)
  let g:airline#themes#jellybeans#palette.normal_modified = {
        \ 'airline_c': [ '#ffb964', '', 215, '', '' ]
        \ }

  let s:I1 = airline#themes#get_highlight('DbgCurrent', 'bold')
  let s:I2 = s:N2
  let s:I3 = s:N2
